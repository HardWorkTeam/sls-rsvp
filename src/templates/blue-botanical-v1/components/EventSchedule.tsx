                ...
                >
                  ...
                  <div className="flex justify-center">
                    <div 
                      ...
                      style={{ 
                        ...
                        background: 'rgba(106,140,178,0.06)',
                        boxShadow: `0 0 10px rgba(106,140,178,0.1)`
                      }}
                    >
                  ...
                  <div className="relative h-full flex justify-center items-center">
                    ...
                    <div className="relative z-10 py-1 bg-transparent">
                      <svg viewBox="0 0 24 24" className="w-6 h-6 text-[#6A8CB2]">
                  ...
                  <div className="py-4 space-y-1 text-left text-white">
                    ...
                    <a 
                      ...
                      className="inline-flex items-center gap-1.5 text-[10px] font-khmer-body font-bold tracking-wider uppercase hover:opacity-80 mt-1 cursor-pointer text-[#6A8CB2] underline"
                    >
