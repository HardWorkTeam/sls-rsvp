...
import {
  ...
  LotusOrnament,
  SectionHeading,
} from "../../royal-khmer-v1/components/KhmerOrnaments";
...
const INITIAL_WISHES: Wish[] = [
  ...
  },
  {
    id: "w-2",
    name: "លី ម៉ាណែត",
    message: "Happy Wedding Day! Wish you a lifetime of love and happiness.",
  },
  {
    id: "w-3",
    name: "សុខ គង់",
    message: "សូមឱ្យជីវិតអាពាហ៍ពិពាហ៍របស់អ្នកទាំងពីរពេញដោយសំណើច និងភាពរីករាយ!",
  },
  {
    id: "w-4",
    name: "គង់ ស្រីលក្ខ",
    message:
      "សូមអបអរសាទរ! ជូនពរគូស្វាមីភរិយាថ្មីមានទ្រព្យសម្បត្តិហូរហៀរ និងសុខសន្តិភាពក្នុងគ្រួសារ។",
  },
  {
    id: "w-5",
    name: "ណារ៉ុង វិចិត្រ",
    message:
      "Congratulations on your special day! Best wishes for a bright future together.",
  },
];
...
export const RsvpForm: React.FC<RsvpFormProps> = ({
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(180deg, #260206 0%, #3D0207 100%)",
      }}
    >
      <div className="max-w-lg mx-auto space-y-10">
        ...
        {success ? (
          ...
          >
            <DrawBorderFrame
              className="p-8 text-center flex flex-col items-center justify-center gap-6"
              style={{
                background: "rgba(92, 3, 12, 0.65)",
          ...
          >
            ...
            >
                  ...
                  {(["attending", "declined"] as AttendStatus[]).map((s) => (
                    <button
                      ...
                      style={{
                        ...
                        color:
                          status === s ? "#FAF6EF" : "rgba(250,246,239,0.5)",
              ...
              <button
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #8B6914, #C9A84C, #FFE5A3, #C9A84C, #8B6914)",
                  color: "#5C030C",
                  letterSpacing: "0.06em",
                  boxShadow: submitting
                    ? "none"
                    : "0 6px 20px rgba(232,201,122,0.25)",
                }}
              >
                {submitting ? (
