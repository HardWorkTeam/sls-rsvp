  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(45deg, #D4A020 0px, #D4A020 1px, transparent 1px, transparent 18px)",
        }}
      />
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4">
        ...
        <div className="text-center space-y-2 mb-10">
          ...
          <h2
            className="font-khmer-title text-2xl"
        ...
        >
          <DrawBorderFrame
            ...
            style={{
              background:
                "linear-gradient(185deg, rgba(92, 58, 0, 0.94) 0%, rgba(61, 34, 0, 0.98) 100%)",
            ...
            {(groom.photo || bride.photo) && (
              <div className="flex items-end justify-center gap-4 w-full py-2">
                ...
                <div
                  ...
                  style={{ background: "rgba(212,160,32,0.2)" }}
                />
                {bride.photo && (
                  <div className="flex flex-col items-center gap-1.5">
                    <div className="relative w-20 h-20 rounded-full overflow-hidden border-2 border-[#D4A020]/50 shadow-[0_0_0_3px_rgba(212,160,32,0.12)]">
            ...
            <div className="space-y-4 w-full text-xs text-[#FFF8E8]">
              ...
              {eventDays.map((day, i) => (
                <div key={day.id} className="space-y-2">
                  {multiDay && (
                    <p className="font-khmer-body text-[11px] font-bold uppercase tracking-widest text-[#D4A020]">
                      ថ្ងៃទី{i + 1} · Day {i + 1}
                    </p>
                  )}
                  {day.solarKh && (
                    <p className="font-khmer-body font-semibold text-[#FFF8E8]">
                      {day.solarKh}
                    </p>
                  )}
                  ...
                  <div className="border-y border-[#D4A020]/25 py-2 max-w-sm mx-auto flex items-center justify-center gap-6 font-serif-en text-[11px] md:text-xs tracking-widest text-[#D4A020]">
                    ...
                    <div className="flex flex-col items-center border-x border-[#D4A020]/20 px-4">
                      ...
                      <span className="text-xl md:text-2xl font-bold my-0.5 text-[#FFF8E8]">
                        {day.dateDay}
                      </span>
