  ...
  return (
    <section className="py-20 px-6" style={{ backdropFilter: 'blur(1px)' }}>
      <div className="max-w-md mx-auto space-y-6">
        ...
        {embedUrl ? (
          <div className="overflow-hidden rounded-2xl" style={{ border: '2px solid rgba(212,160,32,0.35)', aspectRatio: '4/3', position: 'relative' }}>
            <iframe
              src={embedUrl}
              width="100%"
              height="100%"
        ...
        {primaryEvent.locationName && (
          <p className="font-khmer-body text-sm text-center" style={{ color: '#ffffff', opacity: 0.9 }}>
            {primaryEvent.locationName}
          </p>
        )}
        ...
        {primaryEvent.googleMapsUrl && (
          <div className="text-center">
            <a
              ...
              style={{ background: 'rgba(212,160,32,0.15)', border: '2px solid rgba(212,160,32,0.5)', color: '#D4A020' }}
            >
              Get Directions ↗
            </a>
          </div>
