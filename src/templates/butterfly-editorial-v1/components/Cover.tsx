...
export const Cover: React.FC<CoverProps> = ({
  ...
  const [phase, setPhase] = useState<
    "sealed" | "flap-open" | "card-rise" | "card-fullscreen" | "reveal"
  >("sealed");
      ...
      {coverImage && (
        <>
          ...
          <div
            ...
            style={{ background: "rgba(20,15,10,0.45)", zIndex: 3 }}
          />
        </>
      )}
      ...
      <AnimatePresence>
        {phase !== "reveal" && (
          <m.div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 40%, rgba(90,18,29,0.2) 0%, rgba(15,3,5,0.97) 100%)",
            }}
          >
            {/* Top label */}
            <m.div
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(145deg, #5A121D 0%, #2D0610 100%)",
                  boxShadow:
                    "0 40px 80px rgba(0,0,0,0.7), inset 0 0 60px rgba(0,0,0,0.5)",
                }}
              >
              ...
              >
                <div className="text-center space-y-3">
                  ...
                  >
                    {couple.groom.nameKh.split(" ")[0]} &amp;{" "}
                    {couple.bride.nameKh.split(" ")[0]}
                  </p>
                  <p
              ...
              {guestName && (
                ...
                >
                  <p
                    className="text-[7px] tracking-[0.2em] font-medium uppercase"
                    style={{
                      color: "#C5A059",
                      fontFamily: "'Kantumruy Pro', sans-serif",
                    }}
                  ...
                  <p
                    className="text-sm mt-0.5 font-semibold whitespace-nowrap"
                    style={{
                      color: "#5A121D",
                      fontFamily: "'Cormorant Garamond', serif",
                    }}
                ...
                {phase === "sealed" && (
                  ...
                  >
                    <button
                      ...
                      style={{
                        background:
                          "radial-gradient(circle at 40% 35%, #FFEFCB 0%, #C5A059 50%, #8F6F30 100%)",
                        border: "3px double rgba(90, 18, 29, 0.6)",
                        boxShadow:
                          "0 8px 25px rgba(0,0,0,0.6), inset 0 1px 3px rgba(255,255,255,0.3)",
                      }}
        ...
        {phase === "reveal" && (
          ...
          >
            ...
            <div
              ...
              style={{
                boxShadow:
                  "0 30px 60px rgba(90,18,29,0.06), 0 0 0 1px rgba(197,160,89,0.15)",
              }}
            >
              {/* Inner margin frame */}
              ...
              {guestName && (
                <div
                  className="mx-auto px-5 py-2.5 rounded-full w-fit border border-[#C5A059]/15 mt-6"
            ...
            >
              ...
              <m.div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, #5A121D, transparent)",
                }}
              />
            </m.div>
          </m.div>
